...
Objetivo de control: partiendo de una condici?n inicial nula en el desplazamiento 
y el ?ngulo en pi, hacer que el carro se desplace a 10 metros evitando las 
oscilaciones de la masa m, considerando que es una gr?a. Una vez que delta=10
...
Qo=1e4*diag([1 10000 1000 0.0001]);    Ro=[100 0; 0 100];
Ko=dlqr(Ao,Bo,Qo,Ro);
%eig(Ao-Bo*Ko)
...
% subplot(3,2,[5:6]);plot(t,u);grid on;title('Acci?n de control');xlabel('Tiempo en Seg.');hold on;
