...
t=0:dt:tf;
periodo=1;%[seg]
torq=1.15*10^-3; %Cuándo lo usaste?
...
subplot(2,1,2);plot(t,TL,'g');grid on;title('Ángulo tita');hold on;
...
% figure(3);hold on;
% plot(t(1:length(u_k)),u_k,'k');grid on;title('Acción de control');xlabel('Tiempo en Seg.');hold on;
